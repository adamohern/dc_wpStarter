...
function evd_add_shortcode_box() {
	add_meta_box( 'evd-shortcode-box', 'EvD Shortcodes', 'evd_render_post_shortcodes', 'post', 'normal', 'high' );
	add_meta_box( 'evd-shortcode-box', 'EvD Shortcodes', 'evd_render_post_shortcodes', 'page', 'normal', 'high' );
}
add_action( 'admin_menu', 'evd_add_shortcode_box' );

function evd_render_post_shortcodes( $object, $box ) { 
$shortcodes = array(
	...
	'list posts by tag (simple)'=>'[evd_query_posts tags=&quot;tag1,tag2&quot;]',
	'list posts by tag (advanced)'=>'[evd_query_posts tags=&quot;tag1,tag2&quot; title=&quot;Title&quot; caption=&quot;Caption&quot; bannerurl=&quot;thumbnail_url&quot; order=&quot;desc&quot;]',
...
foreach($shortcodes as $label => $value){
	echo evd_render_shortcode($label,$value);
}
echo '</table>';

}

function evd_render_shortcode($label,$value){
